...
describe("controller", () => {
  ...
  test("it reset counters", () => {
    let model = {scoreValue: 10, progressValue: 10, attemptsAvailableNumber: 2, defaultAttemptsNumber: 10}
  ...
  test('it explode booster area', () => {
    initialize({tiles, boosterRadius: 2}, {rerenderView: () => {}, explodeTile: () => {}});
  ...
  test('it should create model play field', () => {
    let model = {PLAYFIELD_LENGTH: 10, colorsQuantity: 5, colors: ['blue', 'blue', 'blue', 'blue', 'blue']}
    initialize(model)
    createModelPlayField()
