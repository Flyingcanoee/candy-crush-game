...
export function startGame() {
  ...
  messageBg
    .beginFill(0x061d54)
    .lineStyle(8, 0xf08de3, 0.7)
    .drawRoundedRect(0, 0, 400, 400, 15)
    .endFill();
  ...
  const textMessage = new PIXI.Text('Do you want to start the game?', {
    ...textStyle,
    fontSize: 60,
    fill: '#fc2d75',
  });
  ...
  startNewGameBtn
    .beginFill(0xf08de3)
    .lineStyle(8, 0xf0aae7, 0.7)
    .drawRoundedRect(100, 300, 200, 50, 15)
    .endFill();
  ...
  const textStartNewGame = new PIXI.Text('START NEW GAME', {
    ...textStyle,
    fill: '#961d87',
  });
